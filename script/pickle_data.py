# -*- coding: utf-8 -*-
"""
Created on Tue Apr 26 23:30:05 2022
...
path = r"C:\Users\Yi.Zhu\Projects\COVID\Data\Cambridge\task2\task2\EN_data"  # Change to your data path
inputFile = "data_0426_en_task2.csv"
df = pd.read_csv(os.path.join(path,inputFile))
...
if not os.path.exists("C:/Users/Yi.Zhu/Projects/COVID/Data/Cambridge/task2/data"):
    os.mkdir("C:/Users/Yi.Zhu/Projects/COVID/Data/Cambridge/task2/data")
...
for fold in ["train_noncovid_id", "vad_noncovid_id", "test_noncovid_id"]:
    ...
    for uid in user_all[fold]:
        ...
        if "202" in uid:
            ...
            if len(temp) > 0:
                data_all_noncovid[fold][uid] = temp
f = open("C:/Users/Yi.Zhu/data/audio_0426En_noncovid.pk", "wb")
